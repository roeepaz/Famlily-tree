...
import { Sun, Trophy, BookHeart, ImagePlus, Send } from "lucide-react";
...
export default function ShareUpdateCard() {
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" className="rounded-xl px-4" disabled={!text.trim()}>
